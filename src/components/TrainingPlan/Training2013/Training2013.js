import './Training2013.css'

import React from 'react'

const Training2013 = () => {
  return (
    <div className='plan2011-main'>
            ...
            <div className="tabsStyle col-3">
              ...
              >
                <a
                  ...
                  id="v-tabs-home-tab-02-011"
                  data-mdb-toggle="tab"
                  href="#v-tabs-home-011"
                  role="tab"
                  aria-controls="v-tabs-home-011"
                  aria-selected="true"
                  >السبت</a>
                <a
                  className="nav-link"
                  id="v-tabs-profile-tab-022"
                  data-mdb-toggle="tab"
                  href="#v-tabs-profile-022"
                  role="tab"
                  aria-controls="v-tabs-profile-022"
                  aria-selected="false"
                  >الاثنين</a>
                <a
                  className="nav-link"
                  id="v-tabs-messages-tab-033"
                  data-mdb-toggle="tab"
                  href="#v-tabs-messages-033"
                  role="tab"
                  aria-controls="v-tabs-messages-033"
                  aria-selected="false"
                  >الخميس</a>
              </div>
              {/* <!-- Tab navs --> */}             
            ...
            <div className="col-9  wid-md-100">
              ...
              <div className="tab-content" id="v-tabs-tabContent">
                ...
                <div
                  ...
                  id="v-tabs-home-011"
                  role="tabpanel"
                  aria-labelledby="v-tabs-home-tab-011"
                >
                ...
                <div
                  ...
                  id="v-tabs-profile-022"
                  role="tabpanel"
                  aria-labelledby="v-tabs-profile-tab-022"
                >
                  <div className='part part-1'>
                  <div className='title'>الجزء الاول</div>                   
                    <p>
                ...
                <div
                  className="mainContentStyle tab-pane fade"
                  id="v-tabs-messages-033"
                  role="tabpanel"
                  aria-labelledby="v-tabs-messages-tab-033"
                >
                  <div className='part part-1'>
                    <div className='title'>الجزء الاول</div>                   
                    <p>
